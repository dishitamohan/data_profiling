...
genai.configure(api_key="AIzaSyBFSLOAs6lOMZV9a1FDTzkjRGqlD50qtJg")
...
def add_remediation_to_data(data):
    ...
    If the flag is empty the transaction doesnt need remediation advice, it is not risky, give some suggestions to make it better
    """
    ...
    # Save the results
    data.to_csv(r"D:\DataProfiling_TechnologyHackathon\Team_Repo2\data\remediated_data.csv", index=False, header=True)
    return data
